...
public class PublicationOnlyWithRetryTests : NonParallelTests
{
	private const LazyAsyncThreadSafetyMode Mode = LazyAsyncThreadSafetyMode.PublicationOnlyWithRetry;

	[Fact]
	public async Task GetPublicationOnlyWithRetry_CreatesOnce_OnSuccess()
	{
	...
	[Fact]
	public async Task GetPublicationOnlyWithRetry_Retries_OnError()
	{
	...
	[Fact]
	public async Task GetPublicationOnlyWithRetry_Retries_OnFactoryError()
	{
		const int attempts = 3;
	...
	[Fact]
	public async Task GetPublicationOnlyWithRetry_PublishesOnce_OnSuccess()
	{
	...
	[Fact]
	public async Task GetPublicationOnlyWithRetry_DoesNotPublish_OnError()
	{
		const int attempts = 10;
		const int sleep = 30;
	...
	[Fact]
	public async Task GetPublicationOnlyWithRetry_DoesNotPublish_OnFactoryError()
	{
		const int attempts = 10;
		var asyncLazy = new AsyncLazy<VoidResult>(_ => CtorException.ThrowsDirectly(), Mode);
		var bag = new ConcurrentBag<CtorException>();
	...
	[Fact]
	public async Task GetPublicationOnlyWithRetry_ResetEvenIfNotAwaited_OnError()
	{
		var asyncLazy = new AsyncLazy<VoidResult>(token => CtorException.ThrowsAsync(5, token), Mode);
	...
	[Fact]
	public async Task GetPublicationOnlyWithRetry_ResetEvenIfNotAwaited_OnFactoryError()
	{
		var asyncLazy = new AsyncLazy<VoidResult>(_ => CtorException.ThrowsDirectly(), Mode);
